...
def test_dual_output_with_dated_entry_and_caption(tmp_path: Path) -> None:
    ...
    assert res.tif_path.name == "2001-07-04_113438_Summer Sky Over Beach.tif"
    assert res.jpg_path.name == "2001-07-04_113438_Summer Sky Over Beach.jpg"
    ...
    with pyexiv2.Image(str(res.jpg_path)) as meta:
        ...
        assert exif.get("Exif.Photo.DateTimeOriginal") == "2001:07:04 11:34:38"
